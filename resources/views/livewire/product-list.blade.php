    <div class="mt-9">
        <a href="{{route('create')}}" wire:navigate.hover class="rounded-xl bg-indigo-500 ml-10 p-4 w-32 h-10 text-gray-200">Add Product</a>
        <table class="m-4 w-full text-sm  text-center  rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <a type="button" href="" wire:navigate
