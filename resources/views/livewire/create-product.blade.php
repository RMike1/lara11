    ...
    <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
        ...
        <form id="form" novalidate wire:submit="saveProduct">
            <div class="relative z-0 w-full mb-10">
                <input type="text" name="name" wire:model.live.debounce.500ms='name' placeholder="Name..." required
            ...
            <div class="relative z-0 w-full mb-10">
                <input type="quantity" wire:model.live.debounce.500ms='quantity' placeholder="Quantity.." required
                    class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                @error('quantity')
                    <span class="text-sm text-red-600" id="error">{{ $message }}</span>
                @enderror
            ...
            <div class="relative z-0 w-full mb-10">
                <input type="file" accept="image/jpeg, image/png" name="image" placeholder="" wire:model.live.debounce.500ms='image'
                    class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                @error('image')
                    <span class="text-sm text-red-600" id="error">{{ $message }}</span>
                @enderror
            ...
            <div class="relative z-0 w-full mb-10">
                <input type="number" accept="image/png, image/jpg" name="price" placeholder=" " wire:model.live.debounce.500ms='price'
                    required
